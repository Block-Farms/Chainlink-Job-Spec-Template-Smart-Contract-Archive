...
contract postMultiVariableTemplate is ChainlinkClient, ConfirmedOwner {
  ...
  function requestValue1AndValue2()
    ...
    onlyOwner
  {
    Chainlink.Request memory req = buildChainlinkRequest(externalJobId, address(this), this.fulfillValue1AndValue2AndValue3.selector);
  ...
  event RequestFulfilledValue1AndValue2(bytes32 indexed requestId, uint256 indexed Value3, uint256 indexed Value2, uint256 Value1);

  function fulfillValue1AndValue2AndValue3(bytes32 requestId, uint256 _Value3, uint256 _Value2, uint256 _Value1)
    public
